#!/usr/bin/env python3
"""Index atergo generator for Uchitelno Evangelie.
Licensed under MIT License, detailed here: https://mit-license.org/

Usage:
  atergogenerator.py [-v|--verbose|-s|--silent] <xlsx>...
...
fnames = init("atergogenerator", __doc__, __version__) if __name__ == "__main__" else []
...
from atergo import generate_docx

...
def test_close_biti_incl_hilited():
    sl_sem = MainLangSemantics(
        "sl", 5, [7, 8, 9, 10], VarLangSemantics("sl", 0, [1, 2, 3])
    )
    gr_sem = MainLangSemantics(
    ...
    res = _close(group, sl_sem, gr_sem, incl_hilited=True)
    e1 = (
        [""] * 4
        + [
            "01/W168a14-15",
    ...
    group = [g1, g2]
    res = _close(group, gr_sem, sl_sem, incl_hilited=True)
    e1 = (
        [""] * 4
        + [
            "01/W168a14-15",
...
def test_close_vidit_incl_hilited():
    sl_sem = MainLangSemantics(
        "sl", 5, [7, 8, 9, 10], VarLangSemantics("sl", 0, [1, 2, 3])
    )
    gr_sem = MainLangSemantics(
    ...
    group = [r1.copy(), r2.copy()]
    res = _close(group, sl_sem.var, gr_sem, incl_hilited=True)
    e1 = (
        ["вѣдѣл\ue205 WG оувѣдѣл\ue205 H", "ѹвѣдѣт\ue205 H"]
        + [""] * 2
        + [
    ...
    group = [r1.copy(), r2.copy()]
    res = _close(group, gr_sem.var, sl_sem, incl_hilited=True)
    e1 = (
        ["вѣдѣл\ue205 WG оувѣдѣл\ue205 H", "ѹвѣдѣт\ue205 H"]
        + [""] * 2
        + [
